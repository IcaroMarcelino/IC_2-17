...
lines(1:length(d$V2), d$V2, col = "orange", pch = 2, lwd = 2, lty = 5)
...
lines(1:length(g$V2), g$V2, col = "orange", pch = 2, lwd = 2, lty = 5)
...
lines(1:length(q$V2), q$V2, col = "orange", pch = 2, lwd = 2, lty = 5)

plot.new()
legend("center", legend=c("Highest value","Average value", "Lowest value", "Best Model", "Standard Deviation"),col=c("blue", "red", "darkgreen",  "orange", "black"), lty = c(6,1,6,5,1), lwd = c(2,3,2,3,2), cex =1.5)
dev.off()
remove(g,q,d)
#####################################
#####################################
...
lines(1:25, d$desvmin, col = "darkgreen", pch = 2, lty = 6)
d <- sel_best("DL/Scores/SCR_DL_8_", 0:49, 25, ".csv",2)
lines(1:length(d$V3), d$V3, col = "orange", pch = 2, lwd = 2, lty = 5)
...
lines(1:length(g$V3), g$V3, col = "orange", pch = 2, lwd = 2, lty = 5)
...
lines(1:length(q$V3), q$V3, col = "orange", pch = 2, lwd = 2, lty = 5)


plot.new()
legend("center", legend=c("Slowest","Average", "Highest", "Best Model", "Standard Deviation"),col=c("blue", "red", "darkgreen",  "orange", "black"), lty = c(6,1,6,5,1), lwd = c(2,3,2,3,2), cex =1.5)
dev.off()
remove(g,q,d)
#####################################
#####################################
...
lines(1:length(d$V4), d$V4, col = "orange", pch = 2, lwd = 2, lty = 5)
...
g <- sel_best_game("GP/Log_Fitness/FIT_GP_20_", temp, 200, ".txt", 3,"GP/GP_GAMES/Game_GP_20_")
lines(1:length(g$V4), g$V4, col = "orange", pch = 2, lwd = 2, lty = 5)
...
lines(1:length(q$V4), q$V4, col = "orange", pch = 2, lwd = 2, lty = 5)

plot.new()
legend("center", legend=c("Maximum Amplitude","Average Amplitude", "Minimum Amplitude", "Best Model", "Standard Deviation"),col=c("blue", "red", "darkgreen",  "orange", "black"), lty = c(6,1,6,5,1), lwd = c(2,3,2,3,2), cex =1.5)
dev.off()
remove(g,q,d)
#####################################
#####################################
